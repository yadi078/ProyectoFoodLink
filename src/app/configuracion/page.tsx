    ...
    <div className="bg-[#faf8f5] min-h-screen pb-20">
      <div className="max-w-4xl mx-auto px-3 sm:px-4 py-4 sm:py-6 md:py-8">
        ...
        <div className="mb-4 sm:mb-6">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1 sm:mb-2 flex items-center gap-2">
          ...
          <div className="bg-white rounded-xl shadow-soft p-4 sm:p-6 mb-4 sm:mb-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 flex items-center gap-2">
                ...
                <span className="hidden xs:inline">Información del Perfil</span>
                <span className="xs:hidden">Perfil</span>
              </h2>
              {!modoEdicion && (
                <button
                  onClick={() => setModoEdicion(true)}
                  className="flex items-center justify-center gap-2 p-2 sm:px-4 sm:py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-all duration-200 shadow-soft hover:shadow-medium"
                  title="Editar Perfil"
                >
                  <svg
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="px-4 py-2 bg-gray-100 rounded-lg border border-gray-200">
                  ...
                  <p className="text-xs text-gray-500 italic mt-1 ml-7">
                    No editable
                  </p>
                </div>
              </div>
            ...
            {modoEdicion && (
              <div className="flex flex-col sm:flex-row gap-3 mt-6 pt-6 border-t border-gray-200">
                <button
                  ...
                  disabled={guardando}
                  className="flex-1 flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-primary-500 text-white rounded-lg hover:bg-primary-600 disabled:bg-gray-400 disabled:cursor-not-allowed transition-all duration-200 shadow-soft hover:shadow-medium font-semibold text-sm sm:text-base"
                >
                  {guardando ? (
                    <>
                ...
                <button
                  ...
                  disabled={guardando}
                  className="flex-1 flex items-center justify-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-semibold text-sm sm:text-base"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
