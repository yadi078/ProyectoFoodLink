...
service cloud.firestore {
  match /databases/{database}/documents {
    ...
    match /vendedores/{vendedorId} {
      // Permitir lectura: todos los vendedores activos pueden ser vistos por cualquiera
    ...
    match /platillos/{platilloId} {
      // Permitir lectura: todos los platillos disponibles pueden ser vistos
      allow read: if isAuthenticated();
    ...
    match /calificaciones/{calificacionId} {
      // Permitir lectura: todos pueden ver las calificaciones
      allow read: if isAuthenticated();
